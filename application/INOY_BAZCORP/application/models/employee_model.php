...
class Employee_model extends CI_Model
{
	...
	public function get_employee_all()
	{
        ...
        position_level.name,
        organisation_structure.structure_name');
        $query->from('employee');
        ...
        $query->join('position_level', 'position_level.id_position_level=employee.position_level', 'LEFT');
       $query->join('organisation_structure', 'organisation_structure.id_organisation_structure=employee.organisation_structure_id', 'LEFT');
    ...
    public function save_employeeWW($data)
    {
        $this->db->trans_start();
    ...
    public function save_employee($data)
    {
        ...
        $data_input["full_name"]         =   $data["full_name"];
        $data_input['employment_type']   =   $data['employment_type'];
        $data_input["employee_status"]   =   1;
        $data_input["employee_contract_type"] =   1;
        $data_input["birth_city"]        =   $data["birth_city"];
        $data_input["birth_date"]        =   ($data["birth_date"] == '' ? null : $data['birth_date']);
        $data_input["religion"]          =   ($data["religion"] == '' ? null : $data["religion"]);
        $data_input["gender"]            =   ($data["gender"] == '' ? null : $data["gender"]);
        ...
        $data_input["marital_date"]      =   ($data["marital_date"] == '' ? null : $data['marital_date']);
        $data_input["native"]            =   $data["native"];
        $data_input["position_level"]            =   $data["position_level"];
