...
class Action extends MY_Controller
{
    ...
    public function copy_application_action(){
        $id_application_action=$this->input->post('id_application_action');
        $this->appsetting_model->copy_action($id_application_action);
    }
}
?>