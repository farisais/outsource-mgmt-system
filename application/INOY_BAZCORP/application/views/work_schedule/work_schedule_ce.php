...
$(document).ready(function(){
    ...
    var source =
    {
        ...
        [
            ...
            { name: 'structure'},
            { name: 'structure_name', value: 'structure', values: { source: structuresAdapter.records, value: 'value', name: 'label' }}
        ],
    ...
    function setWorkScheduleColumn(adapter)
    {
        return [
            ...
            { text: 'Title', datafield: 'structure', displayfield: 'structure_name', columntype: 'dropdownlist', width: 150,
                createeditor: function (row, value, editor) {
                    editor.jqxDropDownList({ source: structuresAdapter, displayMember: 'label', valueMember: 'value' });
                }
            }
        ];
    }
