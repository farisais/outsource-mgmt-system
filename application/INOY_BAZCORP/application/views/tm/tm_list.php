...
function CreateData()
{
    load_content_ajax(GetCurrentController(), 153, null, null);
}
...
function EditData()
{
    ...
    if(row != null)
    {
        ...
        load_content_ajax(GetCurrentController(), 154 ,data_post, param);
    }
    else
    {
       ...
       if(confirm("Are you sure you want to delete merk : " + row.type_material))
        {
            ...
            load_content_ajax(GetCurrentController(), 155 ,data_post);
        }
    }
    else
    {
