...
function CreateData()
{
    load_content_ajax(GetCurrentController(), 310, null, null);
}
...
function DeleteData()
{
    ...
    if(row != null)
    {
       if(confirm("Are you sure you want to delete customer : " + row.full_name))
        {
            var data_post = {};
            data_post['id'] = row.id;
            load_content_ajax(GetCurrentController(), 313 ,data_post);
        }
    }
    else
    {
