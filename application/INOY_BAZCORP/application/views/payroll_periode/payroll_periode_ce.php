...
function buttonclick(){
    ...
    //alert(formatDate(date_finish));
    //alert($("#date_finish").val('val'));
    //return false;
    ...
    //alert(id);
      ...
      var data_post = {};
        ...
        load_content_ajax(GetCurrentController(), 321, data_post);
...
<?php endif; ?>
    ...
    function SaveData() {
        ...
        load_content_ajax(GetCurrentController(), 299, data_post);
    }

    function DiscardData()
    {
        load_content_ajax('payroll_periode', 297, null);
    }
