...
function SaveData()
{
    ...
    data_post['id_type_material'] = $("#id_type_material").val(); 
    
    load_content_ajax(GetCurrentController(), 'save_edit_type_material', data_post);
    
}
function DiscardData()
{
    load_content_ajax(GetCurrentController(), 'view_type_material' , null);
}
...
<input type="hidden" id="id_type_material" value="<?php echo (isset($is_edit) ? $data_edit[0]['id_type_material'] : '') ?>" />
