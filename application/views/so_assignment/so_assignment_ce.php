...
$(document).ready(function(){    
    ...
    $('#select-work-schedule-grid').on('rowdoubleclick', function (event) 
    {
        ...
        var urlDetail = "<?php echo base_url() ;?>work_schedule/get_work_schedule_detail_list/" + data.id_work_schedule;
        var sourceDetail =
        {
            datatype: "json",
        ...
        $("#working-schedule-grid").jqxGrid({source: dataAdapterDetail});
    });    
    ...
    //
    //=================================================================================
    var urlDetail = "<?php if (isset($is_edit)):?><?php echo base_url() ;?>work_schedule/get_work_schedule_detail_list/2<?php endif; ?>";
    // var urlDetail = "";
    var sourceDetail =
    {
        datatype: "json",
    ...
    //
    //=================================================================================
    var urlEmployee = "<?php if (isset($is_edit)):?><?php echo base_url() ;?>so_assignment/get_so_assignment_employee_list<?php endif; ?>";
    var sourceEmployee =
    {
        datatype: "json",
        datafields:
    ...
    $("#employee-grid").jqxGrid(
    {
        ...
        rendertoolbar: function (toolbar) {
            $("#add-employee").click(function(){
                row_ws = $('#working-schedule-grid').jqxGrid('getrowdata', parseInt($('#working-schedule-grid').jqxGrid('getselectedrowindexes')));
                ...
                if(row_ws != null) {
                    ...
                    alert("Please select a working schedule");
                }
            });
        ...
        columns: [
            ...
            { text: 'Type', datafield: 'employment_type', displayfield: 'employment_type_name', width: 150}
        ]
    });
    ...
    $("#select-employee-grid").jqxGrid(
    {
        ...
        columns: [
            ...
            { text: 'Full Name', datafield: 'full_name'},
            { text: 'Type', datafield: 'employment_type', displayfield: 'employment_type_name', width: 200}
        ]
    });
    ...
    $('#select-employee-grid').on('rowdoubleclick', function (event) 
    {
        ...
        var commit0 = $("#employee-grid").jqxGrid('addrow', null, data);
