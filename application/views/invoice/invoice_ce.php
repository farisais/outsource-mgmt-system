...
function view_detail_invoice(id){
    //alert(id);
    //return false;
    var url_detail = "<?php echo base_url() ;?>invoice/detail_invoice/"+id;
    var source =
        {
            datatype: "json",
            datafields:
...
function detail_grid_product(){
    ...
    $(document).ready(function () {
        ...
        var urlinquiry = "<?php echo base_url() ;?>payroll/get_wo_list_all?status=open";
        var sourceinquiry =
        {
            datatype: "json",
            datafields:
        ...
        $("#select-payroll-grid").jqxGrid(
        {
            ...
            columns: [
                ...
                { text: 'Amount', dataField: 'id_payroll_wo'},
            ]
        });
        $('#select-payroll-grid').on('rowdoubleclick', function (event) 
        {
            ...
            $("#select-payroll-popup").jqxWindow('close');
             view_detail_invoice(data.id_payroll_wo);
            return false;
            var args = event.args;
            var data = $('#select-payroll-grid').jqxGrid('getrowdata', args.rowindex);
