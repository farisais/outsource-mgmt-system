...
<div id='form-container' style="font-size: 13px; font-family: Arial, Helvetica, Tahoma">
    <div class="form-center" style="padding-top: 30px;padding-left: 30px;">
        <div><h1 style="font-size: 18pt; font-weight: bold;">Application Action / <span><?php echo (isset($is_edit) ? $action_edit[0]['uname'] : ''); ?></span></h1></div>
        <div>
            <table class="table-form">
                ...
                <tr>
                    ...
                    <td class="column-input">
                        <input type="checkbox" id="use-claim" <?php echo (isset($is_edit) && $action_edit[0]['need_claim'] == 1 ? 'checked=checked' : ''); ?> />
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
