...
function SaveData()
{
    ...
    load_content_ajax(GetCurrentController(), 388, data_post);
    
}
function DiscardData()
{
    load_content_ajax(GetCurrentController(), 386 , null);
}
        ...
        <div>
            <table class="table-form">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input class="field" style="width: 92%;" type="text" id="description" value="<?php echo (isset($is_edit) ? $data_edit[0]['description'] : '' ) ?>" />
                    </td>
                </tr>
            </table>
        </div>
