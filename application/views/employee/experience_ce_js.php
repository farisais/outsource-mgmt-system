...
$(document).ready(function(){
    ...
    <?php
    if(isset($is_edit) && count($employee_experience) > 0)
    {?>
    ...
    $('#select-month-from').val('val',<?php echo (!isset($employee_experience[0]['from_month']) ? "''" : $employee_experience[0]['from_month']) ?>);
    $('#select-year-from').val('val', <?php echo (!isset($employee_experience[0]['from_year']) ? "''" : $employee_experience[0]['from_year']) ?>);
    $('#select-month-to').val('val', <?php echo (!isset($employee_experience[0]['to_month']) ? "''" : $employee_experience[0]['to_month']) ?>);
    $('#select-year-to').val('val', <?php echo (!isset($employee_experience[0]['to_year']) ? "''" : $employee_experience[0]['to_year']) ?>);
