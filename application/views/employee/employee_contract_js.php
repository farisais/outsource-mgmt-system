...
$(document).ready(function(){
    ...
    if(isset($is_edit))
    {?>
    $("#position").jqxDropDownList('val', <?php echo ($data_edit[0]['organisation_structure_id'] == null ? null :  $data_edit[0]['organisation_structure_id'])?>);
    //$("#position-level").jqxDropDownList('val', <?php echo ($$data_edit[0]['position_level'] == null ? null : $employee_contract[0]['position_level']) ?>);
