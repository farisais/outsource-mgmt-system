...
function CreateData()
{
    load_content_ajax(GetCurrentController(), 349, null, null);
}
...
function EditData()
{
    ...
    if(row != null)
    {
        ...
        param.push(item);        
        data_post['id'] = row.id;
        load_content_ajax(GetCurrentController(), 351 ,data_post, param);
    }
    else
    {
...
function DeleteData()
{
    ...
    if(row != null)
    {
       if(confirm("Are you sure you want to delete salary type : " + row.salary_type))
        {
            var data_post = {};
            data_post['id'] = row.id;
            load_content_ajax(GetCurrentController(), 391 ,data_post);
        }
    }
    else
    {
