...
class So extends MY_Controller
{
    ...
    public function get_so_survey_list()
    {
        echo "{\"data\" : " . json_encode($this->so_model->get_so_survey($this->input->get('id'))) . "}";
    }
    ...
    {
        echo "{\"data\" : " . json_encode($this->so_model->get_so_schedule($this->input->get('id'))) . "}";
    }
