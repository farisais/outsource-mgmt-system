...
class Insentive extends MY_Controller
{
    ...
    {
        $data = array(
            'salarytype' => $this->insentive_model->get_combo_salary_type(),
            'employees' => $this->insentive_model->get_combo_employees(),
            'payroll_periodes' => $this->insentive_model->get_combo_payroll_periodes(),
    ...
    public function init_create_insentive()
    {
        $data['salarytype'] = $this->insentive_model->get_combo_salary_type();
        //var_dump($data['salarytype']);
        //die();
