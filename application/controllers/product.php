...
class Product extends MY_Controller
{
    ...
    public function get_product_final_list()
    {
        echo "{\"data\" : " . json_encode($this->product_model->get_product_final_all($this->input->get('so'))) . "}";
    }
    ...
    {
        echo "{\"data\" : " . json_encode($this->product_model->get_product_with_valuation()) . "}";
    }
}
?>
